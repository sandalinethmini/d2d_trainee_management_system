    ...
    <div class="content p-4">
        ...
        <div class="card mb-4" >
            ...
            <div class="card-header bg-white font-weight-bold">
                Phase Change Application
            </div>
            <div class="card-body">
                <div class="col-md-12 col-md-auto">

                    <form id="form_application" method="post" action="<?php if($form_valid){ echo base_url().'index.php/application/PhaseChange/printApplication'; }
																				else {echo base_url().'index.php/application/PhaseChange/saveRecord';}?>"  >
                    
                    <div class="form-row">
                    <input type="hidden" id="txtReadOnly" name="txtReadOnly" value="<?php echo set_value('txtReadOnly'); ?>" />
                            
                            <div class="col-md-6 mb-3 ">
                                <label for="validationServer01">Requester Name</label>
                                <div class="input-group">
                                <strong class="text-danger">*</strong>
                                <input type="text" class="form-control <?php if(form_error('txtCustomerName')) echo "is-invalid";  ?>" id="txtCustomerName" name="txtCustomerName" placeholder="-- Requester Full Name --" value="<?php echo set_value('txtCustomerName'); ?>" required maxlength="50" data-toggle="tooltip" data-original-title=" Requester Full Name ">
                     ...
                     <hr style="margin-top: 5px; margin-bottom:0px; border: 0; height: 1px; background-image: linear-gradient(to right, rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0));" class="mb-3">
                      ...
                      <div class="form-row mb-2 ">
                         	<div class="col-md-4 ">
                         		<strong><u>Account Information</u></strong>
                                </div>
                         </div>
                     ...
                     <div class="form-row">
                     		...
                     		<div class=" col-md-3 mb-3 ">
                               <?php /*?> <label >NIC</label><?php */?>
                                <div class="input-group">
                                <strong class="text-danger">*</strong>
                                <input type="text" class="form-control <?php if(form_error('txtNIC')) echo "is-invalid";  ?>" id="txtNIC" name="txtNIC" placeholder="-- Consumer NIC --" value="<?php echo set_value('txtNIC'); ?>"  maxlength="12" minlength="10" required data-toggle="tooltip" data-original-title=" Consumer NIC ">
                                <div class="input-group-append">
                        ...
                        <div class="form-row">
                           ...
                           <div class="col-md-5 mb-3 ">
                            <?php /*?><label for="validationServer01">Contact Numbers </label><?php */?>
                            <div class="form-row"> 
                            	<div class="col-md-6 input-group">
                                	<input type="text" class="form-control " id="txtMobileNo" name="txtMobileNo" placeholder="-- Mobile --" value="<?php echo set_value('txtMobileNo'); ?>"maxlength="10" minlength="10" data-toggle="tooltip" data-original-title=" Mobile No ">
                                    <div class="input-group-append ">
                                ...
                                <div class="col-md-6 input-group">
                                	<input type="text" class="form-control " id="txtPhoneNo" name="txtPhoneNo" placeholder="-- Residence --" value="<?php echo set_value('txtPhoneNo'); ?>" maxlength="10" minlength="10" data-toggle="tooltip" data-original-title=" Residence No " >
                                    <div class="input-group-append ">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-3 mb-3 input-group">
                                ...
                                <strong class="text-danger">*</strong>
                                <select  class="form-control custom-select <?php if(form_error('cmbCurrentSupply')) echo "is-invalid";  ?>"  name="cmbCurrentSupply" id="cmbCurrentSupply" required data-toggle="tooltip" data-original-title=" Current Phase ">
                                  <option value="" >-- Current Phase --</option>
                                  <option value="1" <?php echo set_select('cmbCurrentSupply','1'); ?> >Single Phase 30A</option>
                                  <option value="2" <?php echo set_select('cmbCurrentSupply','2'); ?> >Three Phase 30A</option>
                                </select>
                                <?php echo form_error('cmbCurrentSupply');  ?>
                             ...
                             <div class="col-md-3 mb-3 input-group">
                                ...
                                <strong class="text-danger">*</strong>
                                <select  class="form-control custom-select <?php if(form_error('cmbNewSupply')) echo "is-invalid";  ?>"  name="cmbNewSupply" id="cmbNewSupply"  required data-toggle="tooltip" data-original-title=" Required Phase ">
                                  <option value="" >-- Required Phase --</option>
                                  <option value="1" <?php echo set_select('cmbNewSupply','1'); ?> >Three Phase 30A</option>
                                  <option value="2" <?php echo set_select('cmbNewSupply','2'); ?> >Three Phase 60A</option>
                                </select>
                                <?php echo form_error('cmbNewSupply');  ?>
    ...
    $(document).ready(function () {
		...
		<?php if($form_valid){?>
			setTimeout(function(){ 
				...
				$("#form_application").attr("action", "index.php/application/PhaseChange/saveRecord");
				history.replaceState("", "", "index.php/application/PhaseChange");
			 }, 0);
		<?php }else {?>
				history.replaceState("", "", "index.php/application/PhaseChange");
		<?php } ?>
 ...
 function getConsumer()
 {
	...
	$.ajax({type: 'POST',  dataType:"JSON", 	url: 'index.php/CustomerDB/CustomerDB/getCustomer',data:{'CIF':CIF},	async : false,	success: function (data) {
		 ...
		 else
		 {
			 ...
			 $('#txtCustomerName').val(data.consumer.firstname+" "+data.consumer.lastname);
