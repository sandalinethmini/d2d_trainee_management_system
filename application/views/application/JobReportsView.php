        ...
        <div class="card mb-4" >
            ...
            <div class="card-body">
                <div class="col-md-12 col-md-auto">
                    <form id="form_application" method="post" action="index.php/application/JobReports/getJobDetails"  >
					...
					<div class="row col-md-12">   
                                    ...
                                    <div class="col-md-3">
                                        <select class="form-control" name="cmbReportType" id="cmbReportType" required>
                      ...
                      <div class="row col-md-12">   
                                    ...
                                    <div class="col-md-3">
                                         <input type="text" class="form-control " name="txtstartDate" id="txtstartDate" placeholder="" <?php  if (isset($customer['txtstartDate']))echo 				'value="'.strtoupper($customer['txtstartDate']).'"'; ?>  value="<?php echo set_value('txtstartDate'); ?>"  required>
                                    ...
                                    <div class="col-md-3">
                                        <input type="tel" class="form-control " name="txtendDate" id="txtendDate"  maxlength="10" minlength="10" onkeypress="return isNumber(event)" placeholder="" <?php  if (isset($customer['txtendDate']))echo 'value="'.strtoupper($customer['txtendDate']).'"'; ?>  value="<?php echo set_value('txtendDate'); ?>"  required>
					  ...
					  <div class="row col-md-12">   
                                    ...
                                    <div class="col-md-3">
                                        <?php echo form_dropdown('cmbProvider', $providerList,set_value('cmbProvider'), 'class="form-control"    id="cmbProvider"  data-original-title=" Provider "');  ?>
                                    ...
                                    <div class="col-md-3">
                                        <?php echo form_dropdown('cmbCategory', $categoryList,set_value('cmbCategory'), 'class="form-control"    id="cmbCategory"  data-original-title=" Category "');  ?>
					   ...
					   <div class="row col-md-12">   
                                    ...
                                    <div class="col-md-3">
                                        <?php echo form_dropdown('cmbBranch', $branchCodeList,set_value('cmbBranch'), 'class="form-control"    id="cmbBranch"  data-original-title=" Branch "');  ?>
