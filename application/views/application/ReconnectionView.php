    ...
    <div class="content p-4">
        ...
        <div class="card mb-4" >
            ...
            <div class="card-header bg-white font-weight-bold">
                Account Activate Application
            </div>
            <div class="card-body">
                <div class="col-md-12 col-md-auto">

                    <form id="form_application" method="post" action="<?php if($form_valid){ echo base_url().'index.php/application/ReConnection/printApplication'; }
																				else {echo base_url().'index.php/application/ReConnection/saveRecord';}?>"  >
                     <div class=" ">
                         	<div class="">
                     ...
                     <div class="form-row">
                            <div class="col-md-3 mb-3">
                                ...
                                <strong class="text-danger">*</strong> <input type="text" class="form-control <?php if(form_error('txtAccount')) echo "is-invalid";  ?>" id="txtAccount" name="txtAccount" placeholder="-- Account Number--" value="<?php echo set_value('txtAccount'); ?>" maxlength="10" minlength="10" required data-toggle="tooltip" data-original-title=" Account Number ">
                            ...
                            <div class="col-md-5 mb-3 offset-md-1">
                                    ...
                                    <div class="input-group ">
                                    <strong class="text-danger">*</strong><input type="text" class="form-control <?php if(form_error('txtOwnerName')) echo "is-invalid";  ?>" id="txtOwnerName" name="txtOwnerName" placeholder="-- Current Consumer Name --" value="<?php echo set_value('txtOwnerName'); ?>"  maxlength="50" required data-toggle="tooltip" data-original-title=" Current Consumer Name ">
                                        <div class="input-group-append ">
                        ...
                        <div class="form-row ">
                         ...
                         <div class=" col-md-3 mb-3 ">
                                ...
                                <div class="input-group">
                                	<input type="text" class="form-control <?php if(form_error('txtMobileNo')) echo "is-invalid";  ?>" id="txtMobileNo" name="txtMobileNo" placeholder="-- Mobile --" value="<?php echo set_value('txtMobileNo'); ?>" maxlength="10" minlength="10" data-toggle="tooltip" data-original-title=" Mobile No ">
                                    <div class="input-group-append ">
                            ...
                            <div class="col-md-8 mb-3">
                                   ...
                                   <?php /*?><label >Consumer Address</label><?php */?>
                                    <div class="input-group ">
                                    <input type="text" class="form-control " id="txtPemAddress1" name="txtPemAddress1" placeholder="-- Premises Address --" value="<?php echo set_value('txtPemAddress1'); ?>" maxlength="75" data-toggle="tooltip" data-original-title=" Premises Address " >
                                        <div class="input-group-append ">
    ...
    $(document).ready(function () {
		...
		<?php if($form_valid){?>
			setTimeout(function(){ 
				...
				$("#form_application").attr("action", "index.php/application/ReConnection/saveRecord");
				history.replaceState("", "", "index.php/application/ReConnection");
			 }, 0);
		<?php }else {?>
				history.replaceState("", "", "index.php/application/ReConnection");
		<?php } ?>
