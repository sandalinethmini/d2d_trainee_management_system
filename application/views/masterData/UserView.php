...
<script>
	...
	function updateRecord(recordId)
	{
		...
		{	
			$('#txtEmpNo').val(html.jsonData.system_user_name);
			$('#txtFullName').val(html.jsonData.system_user_full_name);
			/*$('#cmbLocationCode').val(html.jsonData.area_code);  
			subLocationCode = html.jsonData.system_user_area_id; 
			locationCode = html.jsonData.area_code;*/
			$('#txtUserId').val(html.jsonData.system_user_id);
