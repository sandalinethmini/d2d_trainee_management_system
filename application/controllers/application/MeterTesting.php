...
class MeterTesting extends Header_page {
	public function __construct()
	{		
		parent::__construct();
		$this->load->model('application/MeterTestingModel','MeterTesting');
	}
	...
	public function index()
	{
		if($this->headerMenu(2))
		{
			$data = array('form_valid' => false);
       		$this->load->view('application/MeterTestingView',$data);
			$this->footerMenu();
		}
		else
	...
	public function printApplication()
	{
		...
		$this->MeterTesting->print_application($account,$ownerName,$mobileNo,$address1,$address2,$address3);
	}
