...
class SDWANJobReports extends Header_page {
	public function __construct()
	{		
		parent::__construct();
		$this->load->model('application/SDWANJobReportsModel','JobReportsModel');
	}
	...
	public function index()
	{
		if($this->headerMenu(6))
		{
			...
			$data['categoryList'] 	=	$this->JobReportsModel->getCategory();
       		...
       		$this->load->view('application/SDWANJobReportsView',$data);
			$this->footerMenu();
		}
		else
