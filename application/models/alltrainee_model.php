...
class Alltrainee_model extends CI_Model {

  public function get_all_trainees($search = '', $start = 0, $length = 10, $order_column = 0, $order_dir = 'asc') {
  ...
  public function count_all_trainees() {
    return $this->db->count_all('trainee_data');
  }
